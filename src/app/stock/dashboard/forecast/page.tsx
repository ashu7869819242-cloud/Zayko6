...
const BAR_COLORS = ["#10b981", "#059669", "#34d399", "#6ee7b7", "#a7f3d0", "#d1fae5", "#047857"];
            ...
            <div className="bg-zayko-800 border-b border-zayko-700 px-6 py-4">
                <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-lg font-display font-bold text-white">Stock & Demand Forecast</h1>
                            <p className="text-xs text-emerald-400">Demand analysis & stock planning</p>
                        </div>
                    </div>
                    <button
                    ...
                    <>
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8 animate-fade-in">
                            {[
                                ...
                                { label: "Highest Demand Item", value: data.summary.highestDemandItem, sub: `${data.summary.highestDemandQty} units/week`, icon: "🔥", color: "text-emerald-400" },
                        ...
                        <div className="bg-zayko-800/50 border border-zayko-700 rounded-2xl p-4 mb-6 animate-slide-up">
                            <div className="flex flex-wrap items-center gap-3">
                                ...
                                <input type="text" placeholder="Search item…" value={filterItem} onChange={(e) => setFilterItem(e.target.value)}
                                ...
                                />
                                <button onClick={() => setHighDemandOnly(!highDemandOnly)}
                                    className={`px-3 py-2 rounded-xl text-xs font-semibold transition-all ${highDemandOnly ? "bg-emerald-500 text-zayko-900" : "bg-white/5 text-zayko-400 border border-white/10"}`}
                                >
                                    🔥 High Demand
                                </button>
                                <button onClick={() => setShortageOnly(!shortageOnly)}
                                        ...
                                        <tbody>
                                            {filteredStock.map((s) => (
                                                <tr key={s.itemId} className="border-b border-zayko-700/50 hover:bg-white/5 transition-colors">
                                                    ...
                                                    <td className="px-4 py-3 text-center text-emerald-400 font-semibold">{s.maxDailyDemand}</td>
